...
<meta charset="UTF-8">
<title>상품 등록</title>
<link rel="stylesheet" href="../resources/css/goods/gdJoin.css">
<script
...
<%@ include file = "../header.jsp" %>
	...
	<div class = "right_area">
		...
		<form id="gdjoin_form" method="post">
		<div class="wrap">
			<div class="left_wrap">
			<!-- ------------------------------------------------- -->
			<div class="pdno_wrap">
				...
				<div class="pdno_input_box">
					<input class="pdno_input" name="PDNO">
				</div>
			...
			<div class="name_wrap">
				...
				<div class="name_input_box">
					<input class="name_input" name="PD_NAME">
				</div>
			...
			<div class="maker_wrap">
				...
				<div class="maker_input_box">
					<input class="maker_input" name="PD_MAKER">
				</div>
			</div>
			<!-- ------------------------------------------------- -->			
			<div class="nara_wrap">
				...
				<div class="nara_input_box">
					<input class="nara_input" name="PD_NARA">
				</div>
			</div>
			</div>
			<!-- ------------------------------------------------- -->			
			...
			<div class="size_wrap">
				...
				<div class="size_input_box">
					<input class="size_input" name="PD_SIZE">
				</div>
			...
			<div class="color_wrap">
				...
				<div class="color_input_box">
					<input class="color_input" name="PD_COLOR">
				</div>
			...
			<div class="inpr_wrap">
				...
				<div class="inpr_input_box">
					<input class="inpr_input" name="PD_INPR">
				</div>
			...
			<div class="outpr_wrap">
				...
				<div class="outpr_input_box">
					<input class="outpr_input" name="PD_OUTPR">
				</div>
			...
			<div class="ltcd_wrap">
				...
				<div class="ltcd_input_box">
					<input class="ltcd_input" name="PD_LTCD">
				</div>
		...
		<div class="gdjoin_button_wrap">
			<input type="button" class="gdjoin_button" value="등록하기">
		</div>
		</form>
...
var inprCheck=false;
var outprCheck=false;
var ltcdCheck=false;
var imageCheck=false;

$(document).ready(function(){
	//상품등록 버튼
	$(".gdjoin_button").click(function(){
		...
		var inpr = $('.inpr_input').val();
		var outpr = $('.outpr_input').val();
		var ltcd = $('.ltcd_input').val();
		...
		if(pdnoCheck&&cateCheck&&sizeCheck&&nameCheck&&colorCheck&&inprCheck&&outprCheck&&ltcdCheck&&imageCheck){
            $("#gdjoin_form").attr("action", "/goods/gdJoin");
            $("#gdjoin_form").submit(); 
        }
